var comments = {
  ...
  // PARAM opt : AJAX options
    ...
    xhr.open('POST', "/var/www/sixconsoles.no/html/2c-ajax-comments.php", true);
  ...
  // load() : load comments
    ...
    comments.ajax({
      ...
      //kanskje bruke innerText for bedre sikkerthet hvis det fungerer
      load : function (res) {
  ...
  //       rid : reply ID
    ...
    comments.ajax({
      data: {
        req: "reply",
        reply_id: rid
      },//innerText istendofoeroof html blabla
      load: function (res) {
